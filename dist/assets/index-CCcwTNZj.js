(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function r(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(o){if(o.ep)return;o.ep=!0;const a=r(o);fetch(o.href,a)}})();const K=.2,R=2,z=.05,et=.0022,at=/(https?:\/\/[^\s<>"]+)/gi,W="Write the task here...",u=[],d=[];let p=null,b=1,_,k=null,x=null,M=null,v=!1,h=!1,y=!1,T=null;const st="tasktrack-file-handle-db",w="handles",B="primary",rt=document.querySelector("#app"),H=()=>new Promise((t,e)=>{if(!window.indexedDB){t(null);return}const r=window.indexedDB.open(st,1);r.onupgradeneeded=()=>{const n=r.result;n.objectStoreNames.contains(w)||n.createObjectStore(w)},r.onsuccess=()=>{t(r.result)},r.onerror=()=>{e(r.error)}}),nt=async()=>{const t=await H();return t?new Promise((e,r)=>{const a=t.transaction(w,"readonly").objectStore(w).get(B);a.onsuccess=()=>{e(a.result??null)},a.onerror=()=>{r(a.error)}}):null},ot=async t=>{const e=await H();e&&await new Promise((r,n)=>{const s=e.transaction(w,"readwrite").objectStore(w).put(t,B);s.onsuccess=()=>{r()},s.onerror=()=>{n(s.error)}})},it=async()=>{const t=await H();t&&await new Promise((e,r)=>{const a=t.transaction(w,"readwrite").objectStore(w).delete(B);a.onsuccess=()=>{e()},a.onerror=()=>{r(a.error)}})},Y=async(t,e=!0)=>{if(!t?.queryPermission||!t.requestPermission)return!1;const r=e?{mode:"readwrite"}:{mode:"read"};return await t.queryPermission(r)==="granted"?!0:await t.requestPermission(r)==="granted"},dt=t=>({id:t,title:`#${t}`,details:"",completed:!1,notes:[]}),O=(t,e,r=[],n=[],o=1)=>({id:t,name:e,tasks:r,trashedTasks:n,nextTaskNumber:o}),g=t=>t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;"),J=t=>{const e=t??"";let r="",n=0;for(const o of e.matchAll(at)){const a=o.index??0,s=o[0];r+=g(e.slice(n,a)),r+=`<a href="${g(s)}" target="_blank" rel="noopener noreferrer">${g(s)}</a>`,n=a+s.length}return r+=g(e.slice(n)),r.replaceAll(`
`,"<br>")},G=t=>t?.trim()?J(t):`<span class="task-links-placeholder">${g(W)}</span>`,ct=t=>{const e=new Date(t);return Number.isNaN(e.getTime())?"":e.toLocaleString([],{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})},lt=(t,e=!1)=>`${t.toSorted((o,a)=>(o.createdAt??0)-(a.createdAt??0)).map(o=>`
        <li class="timeline-item">
          <div class="timeline-content">
            <time class="timeline-time" datetime="${new Date(o.createdAt).toISOString()}">${g(ct(o.createdAt))}</time>
            <p class="timeline-note">${J(o.text)}</p>
          </div>
        </li>
      `).join("")}${e?`
      ...
      `:""}`,I=t=>Array.isArray(t)?t.map((e,r)=>({id:Number(e.id)||r+1,title:typeof e.title=="string"&&e.title.trim()?e.title:`#${r+1}`,details:typeof e.details=="string"?e.details:"",completed:!!e.completed,notes:Array.isArray(e.notes)?e.notes.map(n=>({text:typeof n?.text=="string"?n.text:"",createdAt:Number(n?.createdAt)||Date.now()})).filter(n=>n.text.trim()):[]})):[],ut=(t,e=[])=>{const r=[...t,...e].reduce((n,o)=>Math.max(n,Number(o?.id)||0),0);return Math.max(1,r+1)},E=()=>d.find(t=>t.id===p)??d[0]??null,A=()=>{const t=E();if(!t){u.splice(0,u.length);return}u.splice(0,u.length,...I(t.tasks))},mt=()=>({boards:d,activeBoardId:p,zoom:b,menuSections:{completed:v,trash:h},sidebarCollapsed:y}),V=async()=>{if(!T)return;const t=await T.createWritable();await t.write(JSON.stringify(mt(),null,2)),await t.close()},N=()=>{V().catch(()=>{})},q=()=>{const t=O(1,"Board 1",[],[],1);d.splice(0,d.length,t),p=t.id,b=1,v=!1,h=!1,y=!1,A()},U=t=>{const e=Array.isArray(t?.boards)?t.boards:[];if(!e.length){q();return}d.splice(0,d.length,...e.map((o,a)=>{const s=I(o?.tasks),i=I(o?.trashedTasks);return O(Number(o?.id)||a+1,typeof o?.name=="string"&&o.name.trim()?o.name:`Board ${a+1}`,s,i,Number(o?.nextTaskNumber)||ut(s,i))}));const r=Number(t?.activeBoardId);p=Number.isFinite(r)?r:d[0].id,d.some(o=>o.id===p)||(p=d[0].id);const n=Number(t?.zoom);Number.isFinite(n)&&(b=F(n,K,R)),v=!!t?.menuSections?.completed,h=!!t?.menuSections?.trash,y=!!t?.sidebarCollapsed,A()},pt=async()=>{if(!window.showOpenFilePicker)return!1;try{const t=await nt();if(!t||!await Y(t,!0))return!1;const n=await(await t.getFile()).text();return T=t,n.trim()?U(JSON.parse(n)):q(),!0}catch{return await it().catch(()=>{}),!1}},ft=async()=>{if(!window.showOpenFilePicker){window.alert("File storage needs a Chromium-based browser and localhost/https context.");return}try{const[t]=await window.showOpenFilePicker({multiple:!1,types:[{description:"TaskTrack data",accept:{"application/json":[".json"]}}]});if(!await Y(t,!0))return;T=t,await ot(T);const n=await(await T.getFile()).text();n.trim()?U(JSON.parse(n)):q(),await V(),m()}catch{}},L=()=>{N()},S=()=>{const t=E();t&&(t.tasks=I(u),L())},bt=()=>{q()},gt=()=>{const t=(d.at(-1)?.id??0)+1;d.push(O(t,`Board ${d.length+1}`,[],[],1)),p=t,A(),L(),m()},ht=t=>{t===p||!d.some(e=>e.id===t)||(S(),p=t,A(),L(),m())},yt=t=>{const e=d.find(n=>n.id===t);if(!e)return;const r=window.prompt("Gi board et navn",e.name)?.trim();r&&(e.name=r,L(),m())},kt=t=>{if(d.length<=1)return;const e=d.find(n=>n.id===t);if(!e||!window.confirm(`Slette board "${e.name}"?`))return;const r=d.findIndex(n=>n.id===t);d.splice(r,1),p===t&&(p=d[0].id,A()),L(),m()},vt=()=>{const t=E();!t||!t.trashedTasks?.length||window.confirm("Empty trash for this board?")&&(t.trashedTasks=[],L(),m())},wt=()=>{N()},Tt=()=>{N()},St=()=>{y=!y,Tt(),m()},Et=t=>{t==="completed"&&(v=!v),t==="trash"&&(h=!h),wt(),m()},Lt=()=>{N()},F=(t,e,r)=>Math.min(r,Math.max(e,t)),$t=t=>{const e=-t*et;return F(e,-.04,.04)},At=()=>{const t=document.querySelector("[data-zoom-value]");t&&(t.textContent=`${Math.round(b*100)}%`)},xt=()=>{const t=document.querySelector("[data-zoom-indicator]");t&&(t.classList.add("is-visible"),clearTimeout(_),_=window.setTimeout(()=>{t.classList.remove("is-visible")},900))},X=t=>{document.body.classList.toggle("is-dragging-task",t)},Q=()=>{M?.remove(),M=null},It=t=>{Q();const e=t.cloneNode(!0);return e.classList.add("task-card-drag-preview"),e.style.width=`${t.offsetWidth}px`,e.style.height=`${t.offsetHeight}px`,e.style.position="fixed",e.style.top="-9999px",e.style.left="-9999px",e.style.transform=`scale(${b})`,e.style.transformOrigin="top left",e.querySelectorAll("input, textarea, button").forEach(r=>{r.setAttribute("tabindex","-1")}),document.body.append(e),M=e,e},D=()=>{k=null,x?.classList.remove("is-dragging-source"),x=null,Q(),X(!1),document.querySelector("[data-trash-zone]")?.classList.remove("is-over")},tt=({showIndicator:t=!1}={})=>{const e=document.querySelector("[data-board]");e&&(e.style.setProperty("--zoom",b.toString()),At(),t&&xt())},P=(t,{showIndicator:e=!0}={})=>{b=F(t,K,R),Lt(),tt({showIndicator:e})},Nt=()=>{const t=E();if(!t)return;const e=t.nextTaskNumber;t.nextTaskNumber+=1,u.push(dt(e)),S(),m()},C=(t,e,r)=>{const n=u.find(o=>o.id===t);n&&(n[e]=r,S())},qt=t=>{const e=u.findIndex(o=>o.id===t);if(e===-1)return;const[r]=u.splice(e,1),n=E();n&&r&&(n.trashedTasks=n.trashedTasks??[],n.trashedTasks.push({...r,deletedAt:Date.now()})),S(),m()},Dt=t=>{const e=u.find(r=>r.id===t);e&&(e.completed=!e.completed,S(),m())},j=(t,e)=>{const r=u.find(o=>o.id===t),n=e.trim();!r||!n||(r.notes.push({text:n,createdAt:Date.now()}),S(),m())},Pt=(t,e)=>{const r=u.findIndex(o=>o.id===t);if(r===-1||e<0||e>=u.length||r===e)return;const[n]=u.splice(r,1);u.splice(e,0,n),S(),m()},Mt=t=>{const e=lt(t.notes,t.completed);return`
