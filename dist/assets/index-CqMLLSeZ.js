...
`,ee=t=>`
  <li class="board-menu-item ${t.id===b?"is-active":""}">
    ${L===t.id?`<input class="board-menu-edit-input" type="text" value="${g(t.name)}" aria-label="Edit board name" data-edit-board-name data-board-id="${t.id}" />`:`<button class="board-menu-switch" type="button" data-switch-board data-board-id="${t.id}">${g(t.name)}</button>`}
