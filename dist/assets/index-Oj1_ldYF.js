(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function r(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(o){if(o.ep)return;o.ep=!0;const a=r(o);fetch(o.href,a)}})();const tt=.2,et=2,X=.05,gt=.0022,ht=/(https?:\/\/[^\s<>"]+)/gi,at="Write the task here...",st=420,kt=300,yt=920,u=[],c=[];let g=null,p=1,Y,v=null,M=null,_=null,x=!1,B=!1,w=!1,k=!1,y=!1,S=null,L=null;const vt="tasktrack-file-handle-db",T="handles",C="primary",wt=document.querySelector("#app"),R=()=>new Promise((t,e)=>{if(!window.indexedDB){t(null);return}const r=window.indexedDB.open(vt,1);r.onupgradeneeded=()=>{const n=r.result;n.objectStoreNames.contains(T)||n.createObjectStore(T)},r.onsuccess=()=>{t(r.result)},r.onerror=()=>{e(r.error)}}),Tt=async()=>{const t=await R();return t?new Promise((e,r)=>{const a=t.transaction(T,"readonly").objectStore(T).get(C);a.onsuccess=()=>{e(a.result??null)},a.onerror=()=>{r(a.error)}}):null},Et=async t=>{const e=await R();e&&await new Promise((r,n)=>{const s=e.transaction(T,"readwrite").objectStore(T).put(t,C);s.onsuccess=()=>{r()},s.onerror=()=>{n(s.error)}})},Lt=async()=>{const t=await R();t&&await new Promise((e,r)=>{const a=t.transaction(T,"readwrite").objectStore(T).delete(C);a.onsuccess=()=>{e()},a.onerror=()=>{r(a.error)}})},rt=async(t,e=!0)=>{if(!t?.queryPermission||!t.requestPermission)return!1;const r=e?{mode:"readwrite"}:{mode:"read"};return await t.queryPermission(r)==="granted"?!0:await t.requestPermission(r)==="granted"},St=t=>({id:t,title:`#${t}`,details:"",completed:!1,width:st,notes:[]}),N=t=>{const e=Number(t);return Number.isFinite(e)?Math.min(yt,Math.max(kt,e)):st},W=(t,e,r=[],n=[],o=1)=>({id:t,name:e,tasks:r,trashedTasks:n,nextTaskNumber:o}),b=t=>t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;"),nt=t=>{const e=t??"";let r="",n=0;for(const o of e.matchAll(ht)){const a=o.index??0,s=o[0];r+=b(e.slice(n,a));const i=s.length>60?`${s.slice(0,60)}…`:s;r+=`<a href="${b(s)}" target="_blank" rel="noopener noreferrer" title="${b(s)}">${b(i)}</a>`,n=a+s.length}return r+=b(e.slice(n)),r.replaceAll(`
`,"<br>")},ot=t=>t?.trim()?nt(t):`<span class="task-links-placeholder">${b(at)}</span>`,$t=t=>{const e=new Date(t);return Number.isNaN(e.getTime())?"":e.toLocaleString([],{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})},At=(t,e=!1)=>`${t.toSorted((o,a)=>(o.createdAt??0)-(a.createdAt??0)).map(o=>`
        <li class="timeline-item">
          <div class="timeline-content">
            <time class="timeline-time" datetime="${new Date(o.createdAt).toISOString()}">${b($t(o.createdAt))}</time>
      ...
      `:""}`,H=t=>Array.isArray(t)?t.map((e,r)=>({id:Number(e.id)||r+1,title:typeof e.title=="string"&&e.title.trim()?e.title:`#${r+1}`,details:typeof e.details=="string"?e.details:"",completed:!!e.completed,width:N(e.width),notes:Array.isArray(e.notes)?e.notes.map(n=>({text:typeof n?.text=="string"?n.text:"",createdAt:Number(n?.createdAt)||Date.now()})).filter(n=>n.text.trim()):[]})):[],It=(t,e=[])=>{const r=[...t,...e].reduce((n,o)=>Math.max(n,Number(o?.id)||0),0);return Math.max(1,r+1)},A=()=>c.find(t=>t.id===g)??c[0]??null,D=()=>{const t=A();if(!t){u.splice(0,u.length);return}u.splice(0,u.length,...H(t.tasks))},xt=()=>({boards:c,activeBoardId:g,zoom:p,menuSections:{completed:w,trash:k},sidebarCollapsed:y}),it=async()=>{if(!L)return;const t=await L.createWritable();await t.write(JSON.stringify(xt(),null,2)),await t.close()},F=()=>{it().catch(()=>{})},O=()=>{const t=W(1,"Board 1",[],[],1);c.splice(0,c.length,t),g=t.id,p=1,w=!1,k=!1,y=!1,D()},dt=t=>{const e=Array.isArray(t?.boards)?t.boards:[];if(!e.length){O();return}c.splice(0,c.length,...e.map((o,a)=>{const s=H(o?.tasks),i=H(o?.trashedTasks);return W(Number(o?.id)||a+1,typeof o?.name=="string"&&o.name.trim()?o.name:`Board ${a+1}`,s,i,Number(o?.nextTaskNumber)||It(s,i))}));const r=Number(t?.activeBoardId);g=Number.isFinite(r)?r:c[0].id,c.some(o=>o.id===g)||(g=c[0].id);const n=Number(t?.zoom);Number.isFinite(n)&&(p=j(n,tt,et)),w=!!t?.menuSections?.completed,k=!!t?.menuSections?.trash,y=!!t?.sidebarCollapsed,D()},Nt=async()=>{if(!window.showOpenFilePicker)return!1;try{const t=await Tt();if(!t||!await rt(t,!0))return!1;const n=await(await t.getFile()).text();return L=t,n.trim()?dt(JSON.parse(n)):O(),!0}catch{return await Lt().catch(()=>{}),!1}},Dt=async()=>{if(!window.showOpenFilePicker){window.alert("File storage needs a Chromium-based browser and localhost/https context.");return}try{const[t]=await window.showOpenFilePicker({multiple:!1,types:[{description:"TaskTrack data",accept:{"application/json":[".json"]}}]});if(!await rt(t,!0))return;L=t,await Et(L);const n=await(await L.getFile()).text();n.trim()?dt(JSON.parse(n)):O(),await it(),m()}catch{}},I=()=>{F()},E=()=>{const t=A();t&&(t.tasks=H(u),I())},qt=()=>{O()},Pt=()=>{const t=(c.at(-1)?.id??0)+1;c.push(W(t,`Board ${c.length+1}`,[],[],1)),g=t,D(),I(),m()},Mt=t=>{t===g||!c.some(e=>e.id===t)||(E(),g=t,D(),I(),m())},J=(t,e)=>{const r=c.find(o=>o.id===t);if(!r){S=null,m();return}const n=e.trim();n&&(r.name=n,I()),S=null,m()},Bt=()=>{S!==null&&(S=null,m())},Ht=t=>{c.find(r=>r.id===t)&&(S=t,m())},Ft=t=>{if(c.length<=1)return;const e=c.find(n=>n.id===t);if(!e||!window.confirm(`Slette board "${e.name}"?`))return;const r=c.findIndex(n=>n.id===t);c.splice(r,1),g===t&&(g=c[0].id,D()),I(),m()},Ot=()=>{const t=A();!t||!t.trashedTasks?.length||window.confirm("Empty trash for this board?")&&(t.trashedTasks=[],I(),m())},zt=()=>{F()},_t=()=>{F()},Ct=()=>{y=!y,_t(),m()},Rt=t=>{t==="completed"&&(w=!w),t==="trash"&&(k=!k),zt(),m()},Wt=()=>{F()},j=(t,e,r)=>Math.min(r,Math.max(e,t)),jt=t=>{const e=-t*gt;return j(e,-.04,.04)},Zt=()=>{const t=document.querySelector("[data-zoom-value]");t&&(t.textContent=`${Math.round(p*100)}%`)},Kt=()=>{const t=document.querySelector("[data-zoom-indicator]");t&&(t.classList.add("is-visible"),clearTimeout(Y),Y=window.setTimeout(()=>{t.classList.remove("is-visible")},900))},ct=t=>{document.body.classList.toggle("is-dragging-task",t)},lt=()=>{_?.remove(),_=null},ut=()=>Array.from(document.querySelectorAll("[data-task-column]")),Xt=(t,e)=>{if(!t||!e||t===e)return;const r=document.querySelector("[data-board]");if(!r)return;const n=ut(),o=n.find(d=>Number(d.dataset.taskId)===t),a=n.find(d=>Number(d.dataset.taskId)===e);if(!o||!a||o===a)return;const s=n.indexOf(o),i=n.indexOf(a);s===-1||i===-1||s===i||(s<i?r.insertBefore(o,a.nextSibling):r.insertBefore(o,a),B=!0)},Yt=t=>ut().findIndex(e=>Number(e.dataset.taskId)===t),Jt=t=>{lt();const e=t.cloneNode(!0);return e.classList.add("task-card-drag-preview"),e.style.width=`${t.offsetWidth}px`,e.style.height=`${t.offsetHeight}px`,e.style.position="fixed",e.style.top="-9999px",e.style.left="-9999px",e.style.transform=`scale(${p})`,e.style.transformOrigin="top left",e.querySelectorAll("input, textarea, button").forEach(r=>{r.setAttribute("tabindex","-1")}),document.body.append(e),_=e,e},P=()=>{v=null,M?.classList.remove("is-dragging-source"),M=null,lt(),ct(!1),x=!1,B=!1,document.querySelectorAll("[data-task-column].is-drop-target").forEach(t=>{t.classList.remove("is-drop-target")}),document.querySelector("[data-trash-zone]")?.classList.remove("is-over")},mt=({showIndicator:t=!1}={})=>{const e=document.querySelector("[data-board]");e&&(e.style.setProperty("--zoom",p.toString()),Zt(),t&&Kt())},z=(t,{showIndicator:e=!0}={})=>{p=j(t,tt,et),Wt(),mt({showIndicator:e})},Vt=()=>{const t=A();if(!t)return;const e=t.nextTaskNumber;t.nextTaskNumber+=1,u.push(St(e)),E(),m()},V=(t,e,r)=>{const n=u.find(o=>o.id===t);n&&(n[e]=r,E())},U=(t,e,{persist:r=!1}={})=>{const n=u.find(o=>o.id===t);n&&(n.width=N(e),r&&E())},Ut=t=>{const e=u.findIndex(o=>o.id===t);if(e===-1)return;const[r]=u.splice(e,1),n=A();n&&r&&(n.trashedTasks=n.trashedTasks??[],n.trashedTasks.push({...r,deletedAt:Date.now()})),E(),m()},Gt=t=>{const e=u.find(r=>r.id===t);e&&(e.completed=!e.completed,E(),m())},G=(t,e)=>{const r=u.find(o=>o.id===t),n=e.trim();!r||!n||(r.notes.push({text:n,createdAt:Date.now()}),E(),m())},Qt=(t,e)=>{const r=u.findIndex(o=>o.id===t);if(r===-1||e<0||e>=u.length||r===e)return;const[n]=u.splice(r,1);u.splice(e,0,n),E(),m()},te=t=>{const e=At(t.notes,t.completed);return`
...
`,ee=t=>`
  <li class="board-menu-item ${t.id===g?"is-active":""}">
    ${S===t.id?`<input class="board-menu-edit-input" type="text" value="${b(t.name)}" aria-label="Edit board name" data-edit-board-name data-board-id="${t.id}" />`:`<button class="board-menu-switch" type="button" data-switch-board data-board-id="${t.id}">${b(t.name)}</button>`}
